                ...
                try {
                    ...
                    try {
                        ...
                        if (rs.next()) {
                            ...
                            sukses = jur.simpanJurnal(Nomor.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""), "U", "PEMASUKAN LAIN-LAIN" + ", OLEH " + Toko.nip);
                        }
                    } catch (Exception e) {
                        sukses = false;
                    ...
                    if (sukses == true) {
                        sukses = Sequel.menyimpantf2("tagihan_sadewa", "'" + Nomor.getText() + "','-','" + Keterangan.getText().replaceAll("'", "") + "','-',concat('" + Valid.SetTgl(Tanggal.getSelectedItem() + "")
                                + "',' ',CURTIME()),'Pelunasan','" + total + "','" + pemasukan.getText() + "','Sudah','" + Toko.nip + "'", "No.Transaksi");
                    }
                } catch (Exception e) {
                    sukses = false;
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                sukses = jur.simpanJurnal("-", Valid.SetTgl(Tanggal.getSelectedItem() + ""), "U", "PEMBATALAN PEMASUKAN LAIN-LAIN" + ", OLEH " + Toko.nip);
                            }
                        } catch (Exception e) {
                            sukses = false;
                            System.out.println("Jurnal : " + e);
