                ...
                try {
                    ...
                    try {
                        ...
                        if(rs.next()){
                            ...
                            sukses=jur.simpanJurnal("-",Valid.SetTgl(Tanggal.getSelectedItem()+""),"U","PENGELUARAN HARIAN"+", OLEH "+Toko.nip);
                        } 
                    } catch (Exception e) {
                        sukses=false;
                    ...
                    try {
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                sukses=jur.simpanJurnal("-",Valid.SetTgl(Tanggal.getSelectedItem()+""),"U","PEMBATALAN PENGELUARAN HARIAN"+", OLEH "+Toko.nip);
                            } 
                        } catch (Exception e) {
                            sukses=false;
                            System.out.println("Notif : "+e);
