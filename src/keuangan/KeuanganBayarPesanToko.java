...
public final class KeuanganBayarPesanToko extends javax.swing.JDialog {
        ...
        if (no_faktur.getText().trim().equals("")) {
            ...
            try {
                ...
                if (sisahutang > 0) {
                    ...
                    jur.simpanJurnal(no_bukti.getText(), Valid.SetTgl(tgl_bayar.getSelectedItem() + ""), "U", "BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR " + no_faktur.getText() + ", OLEH " + Toko.nip);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            jur.simpanJurnal(no_bukti.getText(), Valid.SetTgl(tgl_bayar.getSelectedItem() + ""), "U", "BATAL BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR " + no_faktur.getText() + ", OLEH " + Toko.nip);
