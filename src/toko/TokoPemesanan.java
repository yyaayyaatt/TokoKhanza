        ...
        if (NoFaktur.getText().trim().equals("")) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                    ...
                    for (i = 0; i < jml; i++) {
                        ...
                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                            if (Sequel.menyimpantf2("toko_detail_pesan", "?,?,?,?,?,?,?,?,?", "Transaksi Penerimaan", 9, new String[]{
                                ...
                                Trackbarang.catatRiwayat(tbDokter.getValueAt(i, 1).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), 0, "Penerimaan", Toko.nip, "Simpan");
                ...
                if (sukses == true) {
                    ...
                    sukses = jur.simpanJurnal(NoFaktur.getText(), Valid.SetTgl(TglPesan.getSelectedItem() + ""), "U", "PENERIMAAN BARANG TOKO" + ", OLEH " + Toko.nip);
                }
    ...
    public void tampil(String noorder) {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + " where toko_detail_surat_pemesanan.no_pemesanan=? and tokobarang.lokasi like " + toko + " order by tokobarang.nama_brng");
            try {
