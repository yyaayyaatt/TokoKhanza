    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoPengajuan.getText().trim().equals("")) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("toko_pengajuan_barang", "?,?,?,?,?,?", "No.Pengajuan", 6, new String[]{
                    NoPengajuan.getText(), kdptg.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""), "Proses Pengajuan", Keterangan.getText(), frmUtama.IDTOKO
                }) == true) {
