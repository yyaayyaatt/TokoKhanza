                    ...
                    if (!tbDokter.getValueAt(i, 0).toString().equals("")) {
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) >= 0) {
                                if (Sequel.menyimpantf2("tokoopname", "?,?,?,?,?,?,?,?,?", "Stok Opname", 9, new String[]{
                                    ...
                                    tbDokter.getValueAt(i, 0).toString(), tbDokter.getValueAt(i, 7).toString(), tbDokter.getValueAt(i, 8).toString(), catatan.getText(), frmUtama.IDTOKO
                                }) == true) {
                                    Trackbarang.catatRiwayat(tbDokter.getValueAt(i, 1).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), 0, "Opname", Toko.nip, "Simpan");
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    public void tampil() {
        try {
            ...
            System.out.println("IDTOKO=" + toko);
            pstampil = koneksi.prepareStatement("select tokobarang.kode_brng, tokobarang.nama_brng,tokojenisbarang.nm_jenis, tokobarang.kode_sat, "
                    ...
                    + " where tokobarang.status='1' and tokobarang.kode_brng like ? and tokobarang.lokasi like " + toko + " or "
                    + " tokobarang.status='1' and tokobarang.nama_brng like ? and tokobarang.lokasi like " + toko + " or "
                    + " tokobarang.status='1' and tokobarang.kode_sat like ? and tokobarang.lokasi like " + toko + " or "
                    + " tokobarang.status='1' and tokojenisbarang.nm_jenis like ? and tokobarang.lokasi like " + toko + " order by tokobarang.nama_brng");
            try {
