        ...
        if (NoRetur.getText().trim().equals("")) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                    ...
                    for (i = 0; i < jml; i++) {
                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                            if (Sequel.menyimpantf2("toko_detail_returpiutang", "?,?,?,?,?,?,?,?", "Transaksi Retur Piutang", 8, new String[]{
                                ...
                                Trackbarang.catatRiwayat(tbDokter.getValueAt(i, 1).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), 0, "Retur Piutang", Toko.nip, "Simpan");
                ...
                if (sukses == true) {
                    ...
                    sukses = jur.simpanJurnal(NoRetur.getText(), Valid.SetTgl(TglRetur.getSelectedItem() + ""), "U", "RETUR PIUTANG TOKO" + ", OLEH " + Toko.nip);
                }
