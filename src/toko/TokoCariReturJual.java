             ...
             try {
                ...
                if(rs.next()){
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            Trackbarang.catatRiwayat(rs2.getString("kode_brng"),0,rs2.getDouble("jml_retur"),"Retur Jual", Toko.nip,"Hapus");
                    ...
                    jur.simpanJurnal(rs.getString("no_retur_jual"),Sequel.cariIsi("select current_date()"),"U","BATAL TRANSAKSI RETUR JUAL TOKO"+", OLEH "+Toko.nip);
