    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPenjualanHarianToko.jasper", "report", "::[ Data Penjualan Harian Toko ]::",
                    ...
                    + "where tokopenjualan.tgl_jual between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and tokopenjualan.toko like " + toko + " "
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select tokopenjualan.nota_jual,tokopenjualan.tgl_jual, "
                    ...
                    + "tokopenjualan.jns_jual,tokopenjualan.ppn,tokopenjualan.nama_bayar "
                    + "from tokopenjualan inner join petugas on tokopenjualan.nip=petugas.nip "
                    + "where tokopenjualan.tgl_jual between ? and ? and tokopenjualan.toko like " + toko + " "
