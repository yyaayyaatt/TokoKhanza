...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                Trackbarang.catatRiwayat(rs2.getString("kode_brng"), 0, rs2.getDouble("jumlah"), "Penerimaan", Toko.nip, "Hapus");
                        ...
                        if (sukses == true) {
                            ...
                            sukses = jur.simpanJurnal(rs.getString("no_faktur"), Sequel.cariIsi("select current_date()"), "U", "BATAL TRANSAKSI PENERIMAAN TOKO" + ", OLEH " + Toko.nip);
                        }
    ...
    public void isCek() {
        if (!DaftarMenu.TPENERIMAAN_BARANG.equals("")) {
