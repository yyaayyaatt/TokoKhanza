        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (nmbar.getText().trim().equals("") && TCari.getText().trim().equals("")) {
                Valid.MyReportqry("rptRiwayatBarangToko.jasper", "report", "::[ Riwayat Barang Toko / Minimarket / Koperasi ]::",
                        ...
                        + "toko_riwayat_barang.tanggal between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and tokobarang.lokasi like " + toko + " order by toko_riwayat_barang.tanggal,toko_riwayat_barang.jam ", param);
            } else {
                Valid.MyReportqry("rptRiwayatBarangToko.jasper", "report", "::[ Riwayat Barang Toko / Minimarket / Koperasi ]::",
                        "select toko_riwayat_barang.kode_brng,tokobarang.nama_brng,"
                        + "toko_riwayat_barang.stok_awal,toko_riwayat_barang.masuk,"
                        ...
                        + "toko_riwayat_barang.status from toko_riwayat_barang "
                        + "inner join tokobarang on toko_riwayat_barang.kode_brng=tokobarang.kode_brng where "
                        + "toko_riwayat_barang.tanggal between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and tokobarang.nama_brng like '%" + nmbar.getText() + "%' and toko_riwayat_barang.kode_brng like '%" + TCari.getText().trim() + "%' and tokobarang.lokasi like " + toko + " or "
                        + "toko_riwayat_barang.tanggal between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and tokobarang.nama_brng like '%" + nmbar.getText() + "%' and tokobarang.nama_brng like '%" + TCari.getText().trim() + "%' and tokobarang.lokasi like " + toko + " or "
                        + "toko_riwayat_barang.tanggal between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and tokobarang.nama_brng like '%" + nmbar.getText() + "%' and toko_riwayat_barang.petugas like '%" + TCari.getText().trim() + "%' and tokobarang.lokasi like " + toko + " or "
                        + "toko_riwayat_barang.tanggal between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and tokobarang.nama_brng like '%" + nmbar.getText() + "%' and toko_riwayat_barang.status like '%" + TCari.getText().trim() + "%' and tokobarang.lokasi like " + toko + " "
        ...
        try {
            if (nmbar.getText().trim().equals("") && TCari.getText().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        ...
                        + "toko_riwayat_barang.status from toko_riwayat_barang "
                        + "inner join tokobarang on toko_riwayat_barang.kode_brng=tokobarang.kode_brng where "
                        + "toko_riwayat_barang.tanggal between ? and ? and tokobarang.lokasi like " + toko + " order by toko_riwayat_barang.tanggal,toko_riwayat_barang.jam ");
            } else {
                ps = koneksi.prepareStatement(
                        "select toko_riwayat_barang.kode_brng,tokobarang.nama_brng,"
                        + "toko_riwayat_barang.stok_awal,toko_riwayat_barang.masuk,"
                        ...
                        + "toko_riwayat_barang.status from toko_riwayat_barang "
                        + "inner join tokobarang on toko_riwayat_barang.kode_brng=tokobarang.kode_brng where "
                        + "toko_riwayat_barang.tanggal between ? and ? and tokobarang.nama_brng like ? and toko_riwayat_barang.kode_brng like ? and tokobarang.lokasi like " + toko + " or "
                        + "toko_riwayat_barang.tanggal between ? and ? and tokobarang.nama_brng like ? and tokobarang.nama_brng like ? and tokobarang.lokasi like " + toko + " or "
                        + "toko_riwayat_barang.tanggal between ? and ? and tokobarang.nama_brng like ? and toko_riwayat_barang.petugas like ? and tokobarang.lokasi like " + toko + " or "
                        + "toko_riwayat_barang.tanggal between ? and ? and tokobarang.nama_brng like ? and toko_riwayat_barang.status like ? and tokobarang.lokasi like " + toko + " order by toko_riwayat_barang.tanggal,toko_riwayat_barang.jam ");
            }
