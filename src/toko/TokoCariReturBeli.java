             ...
             try {
                ...
                if(rs.next()){
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            Trackbarang.catatRiwayat(rs2.getString("kode_brng"),rs2.getDouble("jml_retur"),0,"Retur Beli", Toko.nip,"Hapus");
                    ...
                    jur.simpanJurnal(rs.getString("no_retur_beli"),Sequel.cariIsi("select current_date()"),"U","BATAL TRANSAKSI RETUR BELI TOKO"+", OLEH "+Toko.nip);
