        ...
        if (NoRetur.getText().trim().equals("")) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                    ...
                    for (i = 0; i < jml; i++) {
                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                            if (Sequel.menyimpantf2("toko_detail_returbeli", "?,?,?,?,?,?,?,?", "Transaksi Retur Beli", 8, new String[]{
                                ...
                                Trackbarang.catatRiwayat(tbDokter.getValueAt(i, 1).toString(), 0, Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()), "Retur Beli", Toko.nip, "Simpan");
                ...
                if (sukses == true) {
                    ...
                    sukses = jur.simpanJurnal(NoRetur.getText(), Valid.SetTgl(TglRetur.getSelectedItem() + ""), "U", "RETUR PEMBELIAN TOKO" + ", OLEH " + Toko.nip);
                }
